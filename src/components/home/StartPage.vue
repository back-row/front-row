...
<template>
  <div
    class="start sm:flex flex-col justify-start md:grid grid-cols-2 grid-rows-2 gap-x-3 gap-y-3 mt-4"
  >
    <div
    ...
    >
      <router-link
        ...
        to="/level"
        class="hover:animate-pulse ease-in-out duration-300 hover:scale-110 bg-greenBackRow h-36 w-7/12 m-2 rounded-xl flex items-center justify-center text-whiteBackRow text-4xl sm:text-5xl lg:text-7xl"
