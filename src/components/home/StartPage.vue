...
<template>
  <div class="start grid grid-cols-2 grid-rows-2 gap-x-3 gap-y-3 mt-4">
    ...
    <div class="play col-span-1 row-span-1 row-start-2 col-start-2 flex items-start justify-center">
      <router-link
        to="/level"
        class="hover:animate-pulse ease-in-out duration-300 hover:scale-110 bg-greenBackRow h-36 w-7/12 m-2 rounded-xl text-7xl flex items-center justify-center text-whiteBackRow"
