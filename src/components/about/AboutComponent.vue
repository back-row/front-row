...
<template>
  <div class="flex flex-col items-center">
    <header class="text-center text-7xl text-whiteBackRow m-8">About Us</header>
    <div class="flex container bg-whiteBackRow w-4/5 rounded-2xl">
      <p class="text-center text-blackBackRow text-xl p-24 pt-10 pb-10">
    ...
    <div class="flex justify-evenly m-10 w-4/5 text-blackBackRow">
